...
// ***********************************************************************************************************************************************************************************************************************
   ...
   case 210:
   {
    ...
    ledcAttach(BRDTST_MOTOR_1_A, 50, 14);// assign Motors pin, 50 Hz, 14-bit width
    brdtst_ucIncrementTestStep = 1;
    break;
   }
   case 211:
   ...
   case 212:
   {
    ...
    ledcWrite(BRDTST_MOTOR_1_A,brdtst_uiPCMTest);
    brdtst_uiTimeCount = 0;
 ...
 // ***********************************************************************************************************************************************************************************************************************
   ...
   case 220:
   {
    ...
    pinMode(BRDTST_MOTOR_1_B, OUTPUT); // set I2C_CLK  as input
     //setup PWM for motors
     ledcDetach(BRDTST_MOTOR_1_A);
     //ledcSetup(1, 50,16);// channel 1, 50 Hz, 16-bit width
    ledcAttach(BRDTST_MOTOR_1_B, 50, 14); // assign Motors pin, 50 Hz, 14-bit width
    brdtst_ucIncrementTestStep = 1;
    break;
   }
   case 221:
   ...
   case 222:
   {
    ...
    brdtst_ucIncrementTestStep = 3;
    brdtst_uiPCMTest = 425;  //zero degree
    ledcWrite(BRDTST_MOTOR_1_B, brdtst_uiPCMTest);
    brdtst_uiTimeCount = 0;
   ...
   case 230:
   {
    ...
    pinMode(BRDTST_MOTOR_2_A, OUTPUT); // set I2C_CLK  as input
     //setup PWM for motors
     ledcDetach(BRDTST_MOTOR_1_B);
     //ledcSetup(1, 50,16);// channel 1, 50 Hz, 16-bit width
    ledcAttach(BRDTST_MOTOR_2_A, 50, 16); // assign Motors pins to channels
    brdtst_ucIncrementTestStep = 1;
    break;
   }
   case 231:
   ...
   case 232:
   {
    ...
    brdtst_ucIncrementTestStep = 3;
    brdtst_uiPCMTest = 425;  //zero degree
    ledcWrite(BRDTST_MOTOR_2_A, brdtst_uiPCMTest);
    brdtst_uiTimeCount = 0;
 ...
 // ***********************************************************************************************************************************************************************************************************************
   ...
   case 240:
   {
    ...
    pinMode(BRDTST_MOTOR_2_B, OUTPUT); // set I2C_CLK  as input
     //setup PWM for motors
     ledcDetach(BRDTST_MOTOR_2_A);
     //ledcSetup(1, 50,16);// channel 1, 50 Hz, 16-bit width
    ledcAttach(BRDTST_MOTOR_2_B, 50, 16); // assign Motors pins to channels
    brdtst_ucIncrementTestStep = 1;
    break;
   }
   case 241:
   ...
   case 242:
   {
    ...
    brdtst_ucIncrementTestStep = 3;
    brdtst_uiPCMTest = 425;  //zero degree
    ledcWrite(BRDTST_MOTOR_2_B, brdtst_uiPCMTest);
    brdtst_uiTimeCount = 0;
 ...
 // ***********************************************************************************************************************************************************************************************************************
   ...
   case 250:
   {
    ...
    pinMode(BRDTST_STEPPER_DIR, OUTPUT); // set I2C_CLK  as input
     //setup PWM for motors
     ledcDetach(BRDTST_MOTOR_2_B);
     //ledcSetup(1, 50,16);// channel 1, 50 Hz, 16-bit width
    ledcAttach(BRDTST_STEPPER_DIR, 50, 16); // assign Motors pins to channels
     brdtst_ucIncrementTestStep = 1;
    break;
   }
   case 251:
   ...
   case 252:
   {
    ...
    brdtst_ucIncrementTestStep = 3;
    brdtst_uiPCMTest = 425;  //zero degree
    ledcWrite(BRDTST_STEPPER_DIR, brdtst_uiPCMTest);
    brdtst_uiTimeCount = 0;
 ...
 // ***********************************************************************************************************************************************************************************************************************
   ...
   case 260:
   {
    ...
    pinMode(BRDTST_STEPPER_CLK, OUTPUT); // set I2C_CLK  as input
     //setup PWM for motors
     ledcDetach(BRDTST_STEPPER_DIR);
    //ledcSetup(1, 50,16);// channel 1, 50 Hz, 16-bit width 
    ledcAttach(BRDTST_STEPPER_CLK, 50, 16); // assign Motors pins to channels
    brdtst_ucIncrementTestStep = 1;
    break;
   }
   case 261:
   ...
   case 262:
   {
    ...
    brdtst_ucIncrementTestStep = 3;
    brdtst_uiPCMTest = 425;  //zero degree
    ledcWrite(BRDTST_STEPPER_CLK, brdtst_uiPCMTest);
    brdtst_uiTimeCount = 0;
 ...
 // ***********************************************************************************************************************************************************************************************************************
   ...
   case 270:
   {
    ...
    pinMode(BRDTST_SERVO_1, OUTPUT); // set I2C_CLK  as input
     //setup PWM for motors
     ledcDetach(BRDTST_STEPPER_CLK);
    //ledcSetup(1, 50,16);// channel 1, 50 Hz, 16-bit width
    ledcAttach(BRDTST_SERVO_1, 50, 16); // assign Motors pins to channels
     brdtst_ucIncrementTestStep = 1;
    break;
   }
   case 271:
   ...
   case 272:
   {
    ...
    brdtst_ucIncrementTestStep = 3;
    brdtst_uiPCMTest = 425;  //zero degree
    ledcWrite(BRDTST_SERVO_1, brdtst_uiPCMTest);
    brdtst_uiTimeCount = 0;
 ...
 // ***********************************************************************************************************************************************************************************************************************
   ...
   case 280:
   {
    ...
    pinMode(BRDTST_SERVO_2, OUTPUT); // set I2C_CLK  as input
     //setup PWM for motors
     ledcDetach(BRDTST_SERVO_1);
    //ledcSetup(1, 50,16);// channel 1, 50 Hz, 16-bit width
    ledcAttach(BRDTST_SERVO_2, 50, 16); // assign Motors pins to channels
    brdtst_ucIncrementTestStep = 1;
    break;
   }
   case 281:
   ...
   case 282:
   {
    ...
    brdtst_ucIncrementTestStep = 3;
    brdtst_uiPCMTest = 425;  //zero degree
    ledcWrite(BRDTST_SERVO_2,brdtst_uiPCMTest);
    brdtst_uiTimeCount = 0;
