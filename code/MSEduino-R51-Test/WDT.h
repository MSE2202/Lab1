...
void WDT_EnableFastWatchDogCore0()
{
  ...
  {
    WDT_htTimer0 = timerBegin(1000);
    timerAttachInterrupt(WDT_htTimer0, &WDT_TimeOutCore0);
    timerAlarm(WDT_htTimer0, 5010, true, 0);
...
void WDT_EnableFastWatchDogCore1()
{
  ...
  else
  {
     ...
     WDT_htTimer1 = timerBegin(1000);
    timerAttachInterrupt(WDT_htTimer1, &WDT_TimeOutCore1);  //only use level , edge not working yet
    timerAlarm(WDT_htTimer1, 1010, true, 0);
